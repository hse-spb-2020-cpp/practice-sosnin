...
TEST_CASE("any_cast<>(any*) works") {
    ...
    SUBCASE("any to int") {
        cls_26::any a = 10;
        static_assert(
            std::is_same_v<int *, decltype(cls_26::any_cast<int>(&a))>);
    ...
    SUBCASE("any to std::string") {
        ...
        static_assert(
            std::is_same_v<std::string *,
                           decltype(cls_26::any_cast<std::string>(&a))>);
...
TEST_CASE("any_cast<>(any*) works") {
    ...
    SUBCASE("any to int") {
        ...
        static_assert(
            std::is_same_v<const int *, decltype(cls_26::any_cast<int>(&a))>);
...
static_assert(
    std::is_convertible_v<cls_26::bad_any_cast &, std::logic_error &>);
...
TEST_CASE("any_cast<>(any&) and any_cast<>(const any&) work") {
    ...
    SUBCASE("any to std::string") {
        cls_26::any a = std::string("foo");
        static_assert(
            !std::is_reference_v<decltype(cls_26::any_cast<std::string>(a))>);
        static_assert(
            !std::is_const_v<decltype(cls_26::any_cast<std::string>(a))>);
    ...
    SUBCASE("empty any to different_types") {
        ...
        CHECK_THROWS_AS(cls_26::any_cast<std::string>(a),
                        const cls_26::bad_any_cast &);
    }
...
TEST_CASE("any_cast<T>(any&&) works and moves from") {
    ...
    static_assert(!std::is_reference_v<decltype(
                      cls_26::any_cast<MovableFrom>(std::move(a)))>);
